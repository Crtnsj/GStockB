        ...
        <?php foreach ($orders as $order) { ?>
            <tr>
                ...
                <?php echo ($_SESSION['id_role'] == 1) ?
                    ...
                    <a href='./index.php?uc=order&action=viewDetails&id_co=<?php echo $order->id_co; ?>'>voir les details</a></td>" : "<td><a href='./index.php?uc=order&action=viewDetails&id_co=<?php echo $order->id_co; ?>'>voir les details</a></td>"; ?>
            </tr>
        <?php } ?>
    </tbody>
</table>